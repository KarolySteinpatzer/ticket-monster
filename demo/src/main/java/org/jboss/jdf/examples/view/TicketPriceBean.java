...
public class TicketPriceBean implements Serializable
{
   ...
   public void paginate()
   {
      ...
      TypedQuery<TicketPrice> query = this.entityManager.createQuery(criteria
   ...
   public List<TicketPrice> getAll()
   {
      ...
      CriteriaQuery<TicketPrice> criteria = this.entityManager
            .getCriteriaBuilder().createQuery(TicketPrice.class);
      return this.entityManager.createQuery(
            criteria.select(criteria.from(TicketPrice.class))).getResultList();
   }
